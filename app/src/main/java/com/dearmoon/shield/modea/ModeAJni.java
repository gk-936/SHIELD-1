 ...
 *
 * The native library is built by CMake (see app/CMakeLists.txt) and
 * packaged into the APK as a native shared library (arm64-v8a).
 *
...
public class ModeAJni {
     ...
     * The daemon will call kill(pid, SIGKILL) as root.
     *
